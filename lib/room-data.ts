...
export const roomsData: Room[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Private shower and sink in-room (no toilet)",
      "Clothing cabin for storage",
    ...
    amenities: ["WiFi included", "Bedding provided", "Desk & chair", "Built-in shelves", "Curtains", "Mirror", "Clothing cabin", "Private shower", "Private sink"],
  },
  {
    id: "room-3",
    name: "Room 3",
  ...
  },
  {
    ...
    amenities: ["WiFi included", "Bedding provided", "Desk", "Wardrobe", "Lamp", "USB ports", "Private shower"],
  },
  {
    id: "room-7",
    name: "Room 7",
